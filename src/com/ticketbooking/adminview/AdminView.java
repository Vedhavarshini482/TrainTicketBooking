...
public class AdminView implements AdminViewCallBack {
	...
	public void printBookings(List<ArrayList<String>> userList) {
		for (int i = 0; i < userList.size(); i++) {
			System.out.println("User name : " + userList.get(i).get(0));
			System.out.println("Mail ID : " + userList.get(i).get(1));
			System.out.println("Address : " + userList.get(i).get(2));
			System.out.println("Phone number : " + userList.get(i).get(3));
		}
		adminView();
	}
